...
class TestCrossRef(unittest.TestCase):
    def test_crossref(self):
        self.maxDiff = None
        input_file_path = 'tests/data/crossref_entries.bib'
        entries_expected = {
            'cr1': {
                'ENTRYTYPE': 'inbook',
                'ID': 'cr1',
        ...
        parser = BibTexParser(
            add_missing_from_crossref=True, ignore_nonstandard_types=False
        )
    ...
    def test_crossref_cascading(self):
        ...
        entries_expected = {
            ...
            'r4': {'ENTRYTYPE': 'book', 'ID': 'r4', 'date': '1911'},
        }
    ...
    def test_crossref_cascading_cycle(self):
        input_file_path = (
            'tests/data/crossref_cascading_cycle.bib'
        )
        entries_expected = {
            'circ1': {
                'ENTRYTYPE': 'book',
    ...
    def test_crossref_missing_entries(self):
        input_file_path = (
            'tests/data/crossref_missing_entries.bib'
        )
        entries_expected = {
            'mcr': {
                'ENTRYTYPE': 'inbook',
