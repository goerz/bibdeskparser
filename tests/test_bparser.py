...
from bibdeskparser.bibdatabase import COMMON_STRINGS, BibDataStringExpression
from bibdeskparser.customization import *
from bibdeskparser import customization
...
class TestbibdeskparserList(unittest.TestCase):
    ...
    def test_article_start_bom(self):
        with codecs.open(
            'tests/data/article_start_with_bom.bib', 'r', 'utf-8'
        ) as bibfile:
            bib = BibTexParser(bibfile.read())
    ...
    def test_article_cust_unicode(self):
        with codecs.open(
            ...
            bib = BibTexParser(
                bibfile.read(), customization=customizations_unicode
            )
            res = bib.get_entry_list()
        expected = [
            {
    ...
    def test_article_missing_coma(self):
        with open(
            'tests/data/article_missing_coma.bib', 'r'
        ) as bibfile:
            bib = BibTexParser(bibfile.read())
            res = bib.get_entry_list()
        expected = [
    ...
    def test_oneline(self):
        with open(
            'tests/data/article_oneline.bib', 'r'
        ) as bibfile:
            bib = BibTexParser(bibfile.read())
            res = bib.get_entry_list()
        expected = [
    ...
    def test_article_no_braces(self):
        with open(
            'tests/data/article_no_braces.bib', 'r'
        ) as bibfile:
            bib = BibTexParser(bibfile.read())
            res = bib.get_entry_list()
        expected = [
    ...
    def test_article_special_characters(self):
        with open(
            'tests/data/article_with_special_characters.bib', 'r'
        ) as bibfile:
            bib = BibTexParser(bibfile.read())
            res = bib.get_entry_list()
        expected = [
    ...
    def test_features2(self):
        with open('tests/data/features2.bib', 'r') as bibfile:
            bib = BibTexParser(bibfile.read())
            res = bib.get_entry_list()
            expected = [
                {
