...
{meth}`~bibdeskparser.Library.rename_file`), and the
`add`/`add_abstract`/`add_preprint` defaults for the keyword
arguments of the like-named `Library` methods. The configuration is
