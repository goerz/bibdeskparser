...
{meth}`~bibdeskparser.Library.rename_file`), the
`add`/`add_abstract` defaults for the keyword arguments of the
like-named `Library` methods, and the `known_missing` mapping of
field names to the static groups recording verified-absent
