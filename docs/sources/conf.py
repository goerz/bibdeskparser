...
extlinks = {
    "issue": ("https://github.com/goerz/bibdeskparser/issues/%s", "#"),
    "pr": ("https://github.com/goerz/bibdeskparser/pull/%s", "PR #"),
}
# autodoc2 settings
...
autodoc2_module_all_regexes = [r"bibdeskparser(\..*)?"]
# Every public symbol is re-exported from the top-level `bibdeskparser`
# package (see `src/bibdeskparser/__init__.py`), which is the single
# generated API page; skip generating a (duplicate) page for every
# submodule, whether public or purely internal implementation support.
autodoc2_skip_module_regexes = [r"bibdeskparser\.[a-z_]+$"]
